...
public class Constant : MonoBehaviour
{
    ...
    public static bool isClearSubMission2 = false;
    public static bool isClearMission1 = false;
    public static bool isGetWater= false;
    ...
    public static string[] cardTexts = { "상승", "하강", "전진", "좌회전", "우회전", "반복", "물붓기" };
    ...
    public const int SCENE_STAGE = 0;
    public const int SCENE_STUDY = 1;
    ...
    void Start()
    {
        Constant.currentSceneId = SceneManager.GetActiveScene().buildIndex;

        if (Application.platform != RuntimePlatform.Android&&publicLevelnum!=0)
